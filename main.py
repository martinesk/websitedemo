...
with left:
    ...
    image7 = Image.open('7.jpeg')
    st.image(image7, caption='Modern Art 7')
    image9 = Image.open('9.jpeg')
    st.image(image9, caption='Modern Art 9')
    image11 = Image.open('11.jpeg')
